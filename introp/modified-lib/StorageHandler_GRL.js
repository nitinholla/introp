...
var assignIn = require( "lodash.assignin" ),
	fs = require( "fs" ),
	path = require( "path" ),
	configurationDirectory = require( "./configurationDirectory_GRL" ),
	StorageHandler = function StorageHandler(arg1,arg2) {
		//console.log("log: StorageHandler args"+arg1 + arg2);
		if ( !( this instanceof StorageHandler ) ) {
			return new StorageHandler();
		}
		this._directory = configurationDirectory(arg1,arg2);
	};

assignIn( StorageHandler.prototype, {
...
module.exports = (arg1,arg2) =>{return new StorageHandler(arg1,arg2)};
